...
public class ComparatorWithLambdaForSorting {
	...
	private static Comparator<Integer> c2 = (Integer num1, Integer num2) -> num1.compareTo(num2);
	private static Comparator<Integer> c3 = (x, y) -> x.compareTo(y);
	private static Comparator<String> mycomp = new Comparator<String>() {
		@Override
	...
	private static Comparator<String> strCompAsc =  (s1, s2) -> s1.length() - s2.length();
	private static Comparator<String> strCompDesc = (s1, s2) -> s2.length() - s1.length();
	private static Comparator<String> strCompLength = Comparator.comparingInt(String::length);
